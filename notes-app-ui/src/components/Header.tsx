...
const Header: React.FC = () => {
  ...
  return (
    ...
    <div className="logo">
  <img
    src={scrolled ? '/assets/logo-color-b.png' : '/assets/logo.png'}
    alt="Montfort Logo"
    className="logo-img"
  />
</div>
        ...
        <nav className="nav-center">
          <NavLink to="/" className="nav-link">Montfort Group</NavLink>
          <NavLink to="/trading" className="nav-link">Montfort Trading</NavLink>
          <NavLink to="/projects" className="nav-link">Our Projects</NavLink>
          <NavLink to="/maritime" className="nav-link">Montfort Maritime</NavLink>
